/****************************************************************************
** Image collection for project 'WormHole'.
**
...
**      images/searchfind
**
** Created: Mo Okt 16 17:50:25 2006
...
class MimeSourceFactory_WormHole : public QMimeSourceFactory
{
public:
    MimeSourceFactory_WormHole() {}
    ~MimeSourceFactory_WormHole() {}
...
void qInitImages_WormHole()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_WormHole;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_WormHole()
{
    if ( factory ) {
...
class StaticInitImages_WormHole
{
public:
    StaticInitImages_WormHole() { qInitImages_WormHole(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_WormHole() { }
#else
    ~StaticInitImages_WormHole() { qCleanupImages_WormHole(); }
#endif
};

static StaticInitImages_WormHole staticImages;
