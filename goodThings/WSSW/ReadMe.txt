========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : WSSW
========================================================================


Diese WSSW-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\WSSW.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei WSSW.rc eingebunden.
...
WSSWDlg.h, WSSWDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CWSSWDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in WSSW.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	WSSW.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
